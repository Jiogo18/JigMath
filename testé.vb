...
(x<2) && (distance(y-3.5,z-3.5) <= 4) && huerotate(#FF0000, angle_complexe(y-3.5, z-3.5)-t*2pi()/20)
	(2pi() => 2*pi())
	((0&&(distance((y-3.5),(z-3.5))<=4))&&huerotate(16711680,(angle_complexe((y-3.5),(z-3.5))-(((t*2)*3.141592653589793)/20))))
